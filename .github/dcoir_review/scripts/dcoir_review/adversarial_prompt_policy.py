...
- Prefer root-cause defects in executable changed code over speculative fixture/loader concerns. A directly demonstrated defect in changed executable fixture, test, or benchmark code is actionable within that code and does not require a separate production consumer. Require supplied consuming implementation or test wiring only for claims about fixture loading, scoring, propagation, or downstream production impact; do not hypothesize unseen loader behavior or external impact.
