...
These checks validate benchmark construction, not model output. They inspect
the right-side/current representation of each relevant changed file so deleted
vulnerable lines and negative test literals do not contaminate clean fixtures.
"""
