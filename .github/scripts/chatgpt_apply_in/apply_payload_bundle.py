...
BLOCKED_PREFIXES = (
    ".git/",
    ".github/chatgpt_staging/out/",
    ".github/chatgpt_staging/work/",
    ".github/chatgpt_staging/apply_reports/",
    ".github/chatgpt_staging/failure_reports/",
    ".github/chatgpt_staging/cleanup_requests/",
    ".github/chatgpt_staging/status_reports/",
)
...
def write_apply_outputs(
    *,
    ...
    report_dir = pathlib.Path(".github/chatgpt_staging/apply_reports")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--applied-paths", default=".github/chatgpt_staging/work/applied_paths.txt")
    parser.add_argument("--deleted-paths", default=".github/chatgpt_staging/work/deleted_paths.txt")
    parser.add_argument("--hash-warnings", default=".github/chatgpt_staging/work/hash_warnings.txt")
