...
```text
.github/operator_tools/github_desktop_lane/modules/Dcoir.Logging/Dcoir.Logging.psm1
```
...
`.github/operator_tools/github_desktop_lane/scripts/New-DcoirApplyInPayload.ps1` is the first tool wired to this module. It stages ChatGPT apply-in payloads and returns `log_path` for local failure or success triage.
