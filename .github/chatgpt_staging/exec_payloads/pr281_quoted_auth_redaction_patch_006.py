...
source = replace_function(
    source,
    "redact_header_credential",
    r'''def redact_header_credential(match: re.Match[str]) -> str:
...
source = replace_function(
    source,
    "redact_header_field_credentials",
    r'''def redact_header_field_credentials(text: str) -> str:
    result: list[str] = []
    cursor = 0
...
for needle in [
    ...
    "if text[index] in {'\"', \"'\"}:",
    "def redact_header_field_credentials",
]:
