...
$expected = 'dc682d6e6354325f0f4ee708a8abd55f6329f0aa'
$branch = 'issue-421-openai-gpt-deployment-builder'
$worktree = Join-Path $env:RUNNER_TEMP 'pr423-exact-head-validation-017'
...
try {
    ...
    try {
        ...
        $parityDir = 'project_sources/validation/out_pr423_exact_head_017_parity'
        $releaseDir = 'project_sources/validation/out_pr423_exact_head_017_release'
