...
$requestedSha = '32a0f20271c5f288e750b0a97cee9eac92dd2e27'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr498-v5-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue496-pr498-exact-head-validation-v5-receipt.json') -Encoding utf8

    Write-Host 'Issue #496 / PR #498 exact-head deterministic validation v5 passed.'
}
finally {
