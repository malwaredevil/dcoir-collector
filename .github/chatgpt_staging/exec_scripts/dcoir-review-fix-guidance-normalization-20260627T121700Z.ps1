...
'@ | Set-Content -LiteralPath $patchPath -Encoding UTF8
    ...
    Invoke-Native -FilePath 'git' -ArgumentList @('status', '--short', '--', '.github/dcoir_review/scripts/openrouter_pr_review.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')

    & git diff --quiet -- .github/dcoir_review/scripts/openrouter_pr_review.py .github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py .github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py
