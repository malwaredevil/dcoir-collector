...
$expectedHead = '7555beea5e1de15a20ff21d258bd1bd6486dd6a2'
$expectedTree = 'd87d0b1c2bbee6acfb2218c20c676a5ed634d870'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v42-semantic-review-ledger-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V42_SEMANTIC_REVIEW_LEDGER_VALIDATION_001_PASS'
...
try {
    ...
    try {
        ...
        foreach ($consumer in @('.github/dcoir_review/scripts/dcoir_review/semantic_review_ledger_fingerprints.py','.github/dcoir_review/scripts/dcoir_review/semantic_review_ledger_builder.py','.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v43.py','.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v43_reuse.py','.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v46_context.py','.github/dcoir_review/scripts/dcoir_review/verified_finding_gate_prior.py')) { $consumerText=Get-Content -Raw -LiteralPath $consumer; if ($consumerText -match 'dcoir_review_required_runtime_patch_v41') { throw "Downstream consumer retains historical v41 dependency: $consumer" } }
        ...
        $v43AfterLedgerIndex = [Array]::IndexOf($sequence, 'dcoir_review_required_runtime_patch_v43')
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v34,v37,v38,v39,v41,v42,v45,v47,v48,v50,v51,v52,v55,v58',
            ...
            'semantic_review_ledger_composition=incremental_review_frontier->semantic_review_ledger->v43',
            ...
            "semantic_review_ledger_hooks_bytes=$ledgerHooksBytes",            'incremental_review_frontier_owner=dcoir_review.incremental_review_frontier',
            'incremental_review_frontier_helpers=hooks,state,scope',
            'incremental_review_frontier_composition=v31->incremental_review_frontier->semantic_review_ledger->v43',
