...
$requestedSha = '7a3f491a0873e04e44754ca162bf301ca95ffb9d'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr520-v4-' + $requestedSha.Substring(0,12))
try {
    ...
    foreach ($command in $commands) {
        $index++; Write-Host "[$index/$expectedValidationCount] $command"
