...
$expectedHead = '1eae83b29f916d85416ce9062651679d2ae20262'
$expectedTree = '8fbe61da2a80533c83996143c7cf1fa902c7ce31'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v50-verified-finding-gate-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V50_VERIFIED_FINDING_GATE_VALIDATION_001_PASS'
...
try {
    ...
    try {
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v34,v37,v38,v39,v45,v47,v48,v50,v51,v52,v55,v58',
