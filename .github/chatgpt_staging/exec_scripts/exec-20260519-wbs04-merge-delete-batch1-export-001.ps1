...
$requestId = 'exec-20260519-wbs04-merge-delete-batch1-export-001'
$tableList = 'Work Items,Session Checkpoints,Idea Inbox,Plans,Operator Preferences,Validation Test Cases,Queue Control'
$outputPrefix = 'dcoir_wbs04_merge_delete_batch1_export'
...
$summary = [ordered]@{
    ...
    success = $true
    purpose = 'Read-only WBS04 merge/delete candidate analysis export, batch 1 of 3. Full rows and fields for aggressive row reduction analysis. Delete Queue intentionally excluded from source tables.'
    table_batch = 1
    table_batch_total = 3
    table_list = @('Work Items','Session Checkpoints','Idea Inbox','Plans','Operator Preferences','Validation Test Cases','Queue Control')
...
$summary | ConvertTo-Json -Depth 12 | Out-File -FilePath (Join-Path $readbackDir 'wbs04_merge_delete_batch1_export_summary.json') -Encoding utf8

$lines = New-Object System.Collections.Generic.List[string]
$lines.Add('# WBS04 merge/delete candidate export readback - batch 1')
$lines.Add('')
...
$lines.Add('- scope: batch 1 of 3; full-row/full-field intake for aggressive merge/update/delete-candidate analysis')
...
$lines | Out-File -FilePath (Join-Path $readbackDir 'wbs04_merge_delete_batch1_export_report.md') -Encoding utf8
