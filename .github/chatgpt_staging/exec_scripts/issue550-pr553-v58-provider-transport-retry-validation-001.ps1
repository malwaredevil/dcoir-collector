...
$expectedHead = '4fa7fbb9ec9d287e6a084c2d4ab81212e83bd787'
$expectedTree = '7dddb386b3ca829babc4d0fe59cb83ec0f872bd0'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v58-provider-transport-retry-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V58_PROVIDER_TRANSPORT_RETRY_VALIDATION_001_PASS'
...
$worktree = Join-Path $runnerTemp ('issue550-pr553-v58-validation-' + [Guid]::NewGuid().ToString('N'))
$created = $false
try {
    ...
    try {
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v47,v58',
            'provider_transport_retry_owner=dcoir_review.provider_transport_retry',
            'composition=v54->provider_transport_retry->v55',
