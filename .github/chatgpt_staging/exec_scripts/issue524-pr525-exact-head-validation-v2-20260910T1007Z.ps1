...
$requestedSha = '15955a2d79d3895e0041206c76101b1aaf7caf95'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr525-v2-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue524-pr525-exact-head-validation-v2-receipt.json') -Encoding utf8

    Write-Host 'Issue #524 / PR #525 exact-head deterministic validation v2 passed.'
}
finally {
