...
$text = Replace-RequiredText $text "$newRequestId = 'issue550-pr553-v55-semantic-adjudication-validation-001'" "$newRequestId = 'issue550-pr553-v55-semantic-adjudication-validation-002'" 'retry request id'
$text = Replace-RequiredText $text "$newMarker = 'ISSUE550_PR553_V55_SEMANTIC_ADJUDICATION_VALIDATION_001_PASS'" "$newMarker = 'ISSUE550_PR553_V55_SEMANTIC_ADJUDICATION_VALIDATION_002_PASS'" 'retry terminal marker'
...
$patchedWrapper = Join-Path $env:RUNNER_TEMP 'issue550-pr553-v55-semantic-adjudication-validation-002-wrapper.ps1'
