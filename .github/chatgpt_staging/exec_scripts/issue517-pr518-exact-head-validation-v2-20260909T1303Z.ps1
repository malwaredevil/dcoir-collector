...
$requestedSha = 'cbd6f884abeb3252c84238c8542be479d9249d36'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr518-v2-' + $requestedSha.Substring(0,12))
...
try {
    ...
    } | ConvertTo-Json -Depth 4 | Out-File -LiteralPath (Join-Path $downloads 'issue517-pr518-exact-head-validation-v2-receipt.json') -Encoding utf8

    Write-Host 'Issue #517 / PR #518 exact-head deterministic validation v2 passed.'
}
finally {
