...
$requestedSha = 'facd43b0fe73e0da8b3fb9389779cb073773b424'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr493-rerun3-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue457-pr493-exact-head-validation-rerun3-receipt.json') -Encoding utf8

    Write-Host 'Issue #457 / PR #493 exact-head deterministic validation rerun3 passed.'
}
finally {
