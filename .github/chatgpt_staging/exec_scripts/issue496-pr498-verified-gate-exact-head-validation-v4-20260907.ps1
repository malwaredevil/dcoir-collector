...
$requestedSha = '7e4ebf79aa687d209f20973e6eadab9d46b732e3'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr498-v4-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue496-pr498-exact-head-validation-v4-receipt.json') -Encoding utf8

    Write-Host 'Issue #496 / PR #498 exact-head deterministic validation v4 passed.'
}
finally {
