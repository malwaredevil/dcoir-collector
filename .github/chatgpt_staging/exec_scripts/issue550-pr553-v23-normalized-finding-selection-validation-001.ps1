...
$expectedHead = 'bff345616b202c0296650c05af3f604e089fc2e4'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestRel = '.github/chatgpt_staging/exec_requests/issue550-pr553-v23-normalized-finding-selection-validation-001.json'
...
$worktree = Join-Path $runnerTemp ('issue550-pr553-v23-validation-' + [Guid]::NewGuid().ToString('N'))
$created = $false
try {
    ...
    try {
        ...
        foreach ($retired in @('dcoir_review_required_runtime_patch_v23','dcoir_review_required_runtime_patch_v24','dcoir_review_required_runtime_patch_v25','dcoir_review_required_runtime_patch_v26','dcoir_review_required_runtime_patch_v27','dcoir_review_required_runtime_patch_v28','dcoir_review_required_runtime_patch_v29')) {
            if ($sequence -contains $retired) { throw "Retired module still in production sequence: $retired" }
        }
        foreach ($stableOwner in @('dcoir_review.normalized_finding_selection','dcoir_review.verified_finding_render','dcoir_review.repair_pipeline','dcoir_review.sentinel_selection')) {
        ...
        foreach ($stableOwner in @('dcoir_review.normalized_finding_selection','dcoir_review.verified_finding_render','dcoir_review.repair_pipeline','dcoir_review.repair_reliability','dcoir_review.repair_render','dcoir_review.sentinel_selection')) {
        ...
        $summaryPath = Join-Path $downloads 'issue550-pr553-v23-normalized-finding-selection-validation-001-summary.txt'
        @(
            'result=PASS',
            ...
            'retired=v23,v24,v25,v26,v27,v28,v29',
...
Write-Output 'ISSUE550_PR553_V23_NORMALIZED_FINDING_SELECTION_VALIDATION_001_PASS'
