...
$requestedSha = '2dcdb0266373b35f84d1b335b82fdbc2d108eac0'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr493-rerun1-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue457-pr493-exact-head-validation-rerun1-receipt.json') -Encoding utf8

    Write-Host 'Issue #457 / PR #493 exact-head deterministic validation rerun1 passed.'
}
finally {
