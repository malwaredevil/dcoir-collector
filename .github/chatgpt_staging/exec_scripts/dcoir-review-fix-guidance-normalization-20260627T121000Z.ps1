...
base_path = ".github/dcoir_review/scripts/openrouter_pr_review.py"
replace_once(
    base_path,
...
pareto_path = ".github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py"
replace_once(
    pareto_path,
...
'@ | Set-Content -LiteralPath $patchPath -Encoding UTF8
    ...
    Invoke-Native -FilePath 'python' -ArgumentList @('-m', 'py_compile', '.github/dcoir_review/scripts/openrouter_pr_review.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')
    Invoke-Native -FilePath 'python' -ArgumentList @('.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')
    Invoke-Native -FilePath 'git' -ArgumentList @('diff', '--check', '--', '.github/dcoir_review/scripts/openrouter_pr_review.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')
    Invoke-Native -FilePath 'git' -ArgumentList @('diff', '--', '.github/dcoir_review/scripts/openrouter_pr_review.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')
    Invoke-Native -FilePath 'git' -ArgumentList @('status', '--short')

    & git rm --quiet -- '.github/chatgpt_staging/exec_scripts/dcoir-review-fix-guidance-normalization-20260627T120800Z.ps1'
    if ($LASTEXITCODE -ne 0) { throw ('git rm failed for old script with exit code {0}' -f $LASTEXITCODE) }
    & git rm --quiet -- '.github/chatgpt_staging/exec_scripts/dcoir-review-fix-guidance-normalization-20260627T121000Z.ps1'
    if ($LASTEXITCODE -ne 0) { throw ('git rm failed for current script with exit code {0}' -f $LASTEXITCODE) }

    & git diff --quiet -- .github/dcoir_review/scripts/openrouter_pr_review.py .github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py .github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py .github/chatgpt_staging/exec_scripts/dcoir-review-fix-guidance-normalization-20260627T120800Z.ps1 .github/chatgpt_staging/exec_scripts/dcoir-review-fix-guidance-normalization-20260627T121000Z.ps1
    ...
    Invoke-Native -FilePath 'git' -ArgumentList @('add', '.github/dcoir_review/scripts/openrouter_pr_review.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context.py', '.github/dcoir_review/scripts/openrouter_pr_review_pareto_context_selftest.py')
