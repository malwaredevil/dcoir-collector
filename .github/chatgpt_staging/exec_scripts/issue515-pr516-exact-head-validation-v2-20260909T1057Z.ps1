...
$requestedSha = '46fff4a92e7a5b0e71c39801f258aa61ea1c3dc6'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr516-v2-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue515-pr516-exact-head-validation-v2-receipt.json') -Encoding utf8

    Write-Host 'Issue #515 / PR #516 exact-head deterministic validation v2 passed.'
}
finally {
