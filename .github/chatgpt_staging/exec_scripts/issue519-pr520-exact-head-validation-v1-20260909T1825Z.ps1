...
$requestedSha = '40309aea6ac0932462729af8aec5fc20cdc1e9f2'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr520-v1-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        schema = 'dcoir.issue519.pr520_exact_head_validation.v1'
    ...
    } | ConvertTo-Json -Depth 4 | Out-File -LiteralPath (Join-Path $downloads 'issue519-pr520-exact-head-validation-v1-receipt.json') -Encoding utf8

    Write-Host 'Issue #519 / PR #520 exact-head deterministic validation v1 passed.'
}
finally {
