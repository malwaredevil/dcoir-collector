...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr518-fix-v2-' + $expectedSha.Substring(0,12))
...
try {
    ...
    } | ConvertTo-Json -Depth 4 | Out-File -LiteralPath (Join-Path $downloads 'issue517-pr518-v52-ordering-fix-v2-receipt.json') -Encoding utf8
