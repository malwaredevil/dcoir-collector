...
$requestedSha = 'd33b323b155d26830812431943063ed85d5f5a5e'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr525-v3-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue524-pr525-exact-head-validation-v3-receipt.json') -Encoding utf8

    Write-Host 'Issue #524 / PR #525 exact-head deterministic validation v3 passed.'
}
finally {
