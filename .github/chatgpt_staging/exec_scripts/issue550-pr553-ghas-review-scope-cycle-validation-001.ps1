...
$expectedHead = 'b24aa32e83d69ef3f93258b2675d7aac98f49b01'
$expectedTree = 'bf703010b103180a67a3d741db29fe852b1555cb'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-ghas-review-scope-cycle-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_GHAS_REVIEW_SCOPE_CYCLE_VALIDATION_001_PASS'
