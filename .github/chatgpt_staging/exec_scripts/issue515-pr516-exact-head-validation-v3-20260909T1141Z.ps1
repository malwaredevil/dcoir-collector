...
$requestedSha = 'f8b37bdb98ce4bf7129ad95972980c14bff2624a'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr516-v3-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue515-pr516-exact-head-validation-v3-receipt.json') -Encoding utf8

    Write-Host 'Issue #515 / PR #516 exact-head deterministic validation v3 passed.'
}
finally {
