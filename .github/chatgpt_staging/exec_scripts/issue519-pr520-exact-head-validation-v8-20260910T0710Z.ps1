...
$requestedSha = '8784ca2de850aa72d15de53a60b3f4c182e8da9d'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr520-v8-' + $requestedSha.Substring(0,12))
try {
