...
$expectedHead = '6e702584233ac7998b06882183e8cea4805bb2a5'
$expectedTree = '29c0353a6aaf93229e2a70596d4cabeb31b1e784'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v52-structured-result-recovery-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V52_STRUCTURED_RESULT_RECOVERY_VALIDATION_001_PASS'
...
$worktree = Join-Path $runnerTemp ('issue550-pr553-v52-structured-result-recovery-validation-' + [Guid]::NewGuid().ToString('N'))
$created = $false
try {
    ...
    try {
        ...
        $v50PublicationText = Get-Content -Raw -LiteralPath '.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v50.py'
        ...
        $v50PriorText = Get-Content -Raw -LiteralPath '.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v50_prior.py'
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v34,v37,v38,v39,v45,v47,v48,v51,v52,v55,v58',
