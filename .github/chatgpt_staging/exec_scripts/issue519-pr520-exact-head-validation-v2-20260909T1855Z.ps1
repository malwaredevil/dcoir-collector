...
$requestedSha = '6ba1e273c60f2d5fd22eb18ae3ad5bb6fa317ba4'
$requestedBranch = 'issue-519-openrouter-run-telemetry'
$expectedValidationCount = 53
$expectedChangedPythonCount = 4
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr520-v2-' + $requestedSha.Substring(0,12))
...
try {
    ...
    $pythonFiles = @(
        ...
        '.github/dcoir_review/scripts/dcoir_review/hardened.py',
    ...
    @{
        schema = 'dcoir.issue519.pr520_exact_head_validation.v2'
        issue_number = 519
        pr_number = 520
    ...
    } | ConvertTo-Json -Depth 4 | Out-File -LiteralPath (Join-Path $downloads 'issue519-pr520-exact-head-validation-v2-receipt.json') -Encoding utf8

    Write-Host 'Issue #519 / PR #520 exact-head deterministic validation v2 passed.'
}
finally {
