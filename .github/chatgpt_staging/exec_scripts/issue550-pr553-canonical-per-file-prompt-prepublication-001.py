...
EXPECTED_HEAD = "1275b8e7338bdf5f9677d1d0e0ab3a0ba8dbbb57"
EXPECTED_TREE = "bdaf5f283642791c12570c9a81fe1a738b549458"
BRANCH = "refactor/issue-550-dcoir-runtime-consolidation"
REQUEST_ID = "issue550-pr553-canonical-per-file-prompt-prepublication-001"
TERMINAL = "ISSUE550_PR553_CANONICAL_PER_FILE_PROMPT_PREPUBLICATION_001_PASS"
PATCH_PAYLOAD = os.environ.get("DCOIR_PATCH_PAYLOAD") or ".github/chatgpt_staging/exec_payloads/issue550-pr553-canonical-per-file-prompt-prepublication-001.patch.gz.b64"
EXPECTED_PATCH_SHA = "7694a4ba7a6457b10f88ad13227a688c92ca7ba60c7eba42c660ef6f2ab70502"
...
try:
    ...
    run("git", "add", "-N", "--", ".github/dcoir_review/scripts/dcoir_review/adversarial_prompt_policy.py", cwd=worktree)
    ...
    expected_prompts = {
        120000: (9954, "3da5d676408c7433aa44783f5b859442eb6529d9ff67a268c739522bb10a7fef"),
        9000: (9000, "769a144e5fe42cc8d035c0058a7ef0ea0f5ff99173eda24743fceb620a82c4aa"),
        6000: (6000, "5107927261e64716c3bdaccd211c82b3fe18c4700091f962b2d0bf4d864e62d1"),
        4500: (4500, "128044975cd6c362c8b56c7cd46b043b49b29e4500ae2b8aaa5bd14efb0d21a9"),
        3000: (3000, "2459d8f40442a3648dcfb04bf2fbb7d1d4dd7c9a89a638e485f190c53447c680"),
        1800: (1800, "3c26fd5e12c5416ff9da592652bc9529f30bf6a37866a6d6f83ac72dab036270"),
        1000: (1000, "e28914da1374772da0def2906c9b4ff960523c0519b128de4ad1490b735584c5"),
        700: (700, "ac58f5b0b67fdb2b27c40db4883891a648ef808b004f001863db9bdc044959de"),
    }
