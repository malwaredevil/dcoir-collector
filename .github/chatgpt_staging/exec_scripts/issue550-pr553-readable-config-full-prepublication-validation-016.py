...
inner = downloads / "issue550-pr553-readable-config-full-prepublication-validation-016-inner.py"
...
print("FULL_PREPUBLICATION_VALIDATION_016_WRAPPER_PASS")
