...
$expectedHead = 'f808410ef982c58d16a96e81e5f9798e7437c2ad'
$expectedTree = '33bb44c556f701c87b708af523a918f8250d9eec'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v45-publication-disposition-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V45_PUBLICATION_DISPOSITION_VALIDATION_001_PASS'
...
$worktree = Join-Path $runnerTemp ('issue550-pr553-v45-publication-disposition-validation-' + [Guid]::NewGuid().ToString('N'))
$created = $false
try {
    ...
    try {
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v34,v37,v38,v39,v45,v47,v48,v51,v55,v58',
