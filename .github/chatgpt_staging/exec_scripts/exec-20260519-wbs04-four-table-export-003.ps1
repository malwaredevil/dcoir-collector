...
$requestId = 'exec-20260519-wbs04-four-table-export-003'
...
if ([int]$exportManifest.selected_table_count -ne 4) {
    throw "Expected 4 selected tables; got $($exportManifest.selected_table_count)."
}
...
if ($recordFiles.Count -ne 4) {
    throw "Expected 4 record files; got $($recordFiles.Count)."
}
