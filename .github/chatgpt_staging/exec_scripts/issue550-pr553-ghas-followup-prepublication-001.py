...
SOURCE_PARENT = "237c071cffb071c08774c2e6a17abac94ab31296"
EXPECTED_PATCH_SHA = "2e7f09f111eb330d9c0c762eb900a0cc0da2dd0f46fe1166b726271949683dbc"
REQUEST_ID = "issue550-pr553-ghas-followup-prepublication-001"
TERMINAL = "ISSUE550_PR553_GHAS_FOLLOWUP_PREPUBLICATION_001_PASS"
EXPECTED_PATHS = ('.github/dcoir_review/scripts/dcoir_review/finding_verifier.py', '.github/dcoir_review/scripts/dcoir_review/finding_verifier_contract.py', '.github/dcoir_review/scripts/dcoir_review/publication_contract.py', '.github/dcoir_review/scripts/dcoir_review/publication_disposition.py', '.github/dcoir_review/scripts/dcoir_review/repair.py', '.github/dcoir_review/scripts/dcoir_review/repair_pipeline.py', '.github/dcoir_review/scripts/dcoir_review/repair_reliability.py', '.github/dcoir_review/scripts/dcoir_review/repair_support.py', '.github/dcoir_review/scripts/dcoir_review/semantic_candidate_identity_hooks.py', '.github/dcoir_review/scripts/dcoir_review/semantic_evidence_hardening.py', '.github/dcoir_review/scripts/dcoir_review/verified_finding_gate.py', '.github/dcoir_review/scripts/dcoir_review/verified_finding_gate_prior.py', '.github/dcoir_review/scripts/dcoir_review_finding_comment_render_selftest.py', '.github/dcoir_review/scripts/dcoir_review_repair_pipeline_selftest.py', '.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v32_selftest.py', '.github/dcoir_review/scripts/dcoir_review_required_runtime_patch_v33.py', '.github/dcoir_review/scripts/dcoir_review_runtime_module_loader_selftest.py', '.github/dcoir_review/scripts/dcoir_review_semantic_adjudication_recovery_selftest.py', '.github/dcoir_review/scripts/dcoir_review_semantic_candidate_identity_selftest.py', '.github/dcoir_review/scripts/dcoir_review_verified_finding_gate_publication_selftest.py', '.github/dcoir_review/scripts/dcoir_review_verified_finding_render_selftest.py')
PAYLOAD_REL = ".github/chatgpt_staging/exec_payloads/issue550-pr553-ghas-followup-prepublication-001.patch.gz.b64"
...
payload_source = Path(os.environ.get("DCOIR_PAYLOAD_PATH") or (repo / PAYLOAD_REL)).resolve()
patch = gzip.decompress(base64.b64decode("".join(payload_source.read_text(encoding="ascii").split())))
...
try:
    ...
    if len(changed_python) != 21: raise RuntimeError(f"changed Python count drift: {len(changed_python)}")
    ...
    summary_path.write_text("\n".join([
        ...
        "ghas_followup_cycle_cleanup=true",
        "preexisting_registry_regressions_repaired=true",
