...
$expectedHead = '8aeda78d1b845481e0a9c7995287590f3314e434'
$expectedTree = 'd1efefccfe08cde2abb5317b94f405e32c6a8ebf'
$base = '9dc055d81fba2bcd4e840ad1e9c9645bdc6a6a20'
$branch = 'refactor/issue-550-dcoir-runtime-consolidation'
$requestId = 'issue550-pr553-v34-semantic-evidence-hardening-validation-001'
$requestRel = ".github/chatgpt_staging/exec_requests/$requestId.json"
$requestPath = Join-Path $repo $requestRel
$terminalMarker = 'ISSUE550_PR553_V34_SEMANTIC_EVIDENCE_HARDENING_VALIDATION_001_PASS'
...
try {
    ...
    try {
        ...
        @(
            ...
            'retired=v15,v19,v21,v22,v23,v24,v25,v26,v27,v28,v29,v34,v37,v38,v39,v47,v48,v55,v58',
