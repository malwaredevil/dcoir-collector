...
$patcherSource = '.github/chatgpt_staging/exec_scripts/issue484-pr501-dcoir-findings-fix-v2.py'
$patcherPath = Join-Path $env:RUNNER_TEMP 'issue484-pr501-dcoir-findings-fix-v2.py'
Copy-Item -LiteralPath $patcherSource -Destination $patcherPath -Force
...
$outDir = Join-Path $env:RUNNER_TEMP 'issue484-full-replay-validation-v3'
