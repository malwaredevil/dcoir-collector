...
$requestRel = '.github/chatgpt_staging/exec_requests/issue550-pr553-v28-retirement-validation-001.json'
...
try {
    ...
    try {
        ...
        $summaryPath = Join-Path $downloads 'issue550-pr553-v28-retirement-validation-001-summary.txt'
        @(
            'result=PASS',
...
Write-Output 'ISSUE550_PR553_V28_RETIREMENT_VALIDATION_001_PASS'
