...
REQUEST_ID = "issue550-pr553-canonical-per-file-prompt-prepublication-002"
TERMINAL = "ISSUE550_PR553_CANONICAL_PER_FILE_PROMPT_PREPUBLICATION_002_PASS"
PATCH_PAYLOAD = os.environ.get("DCOIR_PATCH_PAYLOAD") or ".github/chatgpt_staging/exec_payloads/issue550-pr553-canonical-per-file-prompt-prepublication-002.patch.gz.b64"
