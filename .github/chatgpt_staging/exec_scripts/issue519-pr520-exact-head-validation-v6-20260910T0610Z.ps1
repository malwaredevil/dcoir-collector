...
$requestedSha = 'a10644242341bad0545a4d77aadb13e19b3a6b0c'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr520-v6-' + $requestedSha.Substring(0,12))
try {
