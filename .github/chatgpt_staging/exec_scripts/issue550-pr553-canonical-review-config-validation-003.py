...
inner = downloads / "issue550-pr553-canonical-review-config-validation-003-inner.py"
...
replacements = {
    ...
    'TERMINAL = "ISSUE550_PR553_CANONICAL_REVIEW_CONFIG_VALIDATION_001_PASS"':
        'TERMINAL = "ISSUE550_PR553_CANONICAL_REVIEW_CONFIG_VALIDATION_003_PASS"',
...
print("CANONICAL_REVIEW_CONFIG_VALIDATION_003_WRAPPER_PASS")
