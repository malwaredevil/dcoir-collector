...
$requestedSha = '6a789d34e1477431c99df5054ce649911907b2b7'
...
$worktree = Join-Path $env:RUNNER_TEMP ('dcoir-pr498-' + $requestedSha.Substring(0,12))
...
try {
    ...
    @{
        ...
        Out-File -LiteralPath (Join-Path $downloads 'issue496-pr498-exact-head-validation-receipt.json') -Encoding utf8

    Write-Host 'Issue #496 / PR #498 exact-head deterministic validation passed.'
}
finally {
