...
CONTRACT_PATH = Path(".github/github_actions/workflow_modularization_contracts.json")
DEFAULT_JSON_OUTPUT = Path(".github/github_actions/workflow_inventory.json")
DEFAULT_MARKDOWN_OUTPUT = Path(".github/github_actions/workflow_inventory.md")
...
def classify_report_family(path: Path, text: str) -> str:
    if ".github/chatgpt_staging/status_reports/repo-workflows/" in text:
