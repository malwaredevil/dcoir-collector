...
Later issues will create unified bundlers, cross-target drift reports, and operator upload/reconciliation procedures. The seven retired `project_sources/PP-*` references remain documented as historical drift evidence, but the live Gemini manifest now points to the shared source and module contracts.
