...
Tell the operator to copy the SIPR recipient, subject, and message draft into a text document and move it to SIPR using Intelink iSafe: https://isafe.intelink.gov/
