...
| `prime.chunk.03` | `project_sources/agent_runtime/behavior_modules/prime/prime.chunk.03.md` / `03` | shared_behavior_source | materialize_then_compile | adapt | exclude | Requires complete responses and paced operator commands. |
...
| `prime.chunk.08` | `project_sources/agent_runtime/behavior_modules/prime/prime.chunk.08.md` / `08` | shared_behavior_source | materialize_then_compile | adapt | exclude | Defines required analyst-facing response structures. |
...
| `sub_agent.10` | `project_sources/agent_runtime/behavior_modules/specialists/sub_agent.10.md` / `10` | shared_behavior_source | materialize | flatten | exclude | Composes consistent analyst-facing conclusions and reports. |
...
| `prime.chunk.03` | gemini_dcoir_agent, openai_dcoir_analyst | Gemini retains Prime orchestration; OpenAI targets receive flattened, capability-gated adaptations. | Gemini behavior adapter; gemini prime reassembly; provider-specific instruction compilers; shared behavior module manifest | behavior_coverage; byte_identity_adapter; source_contract; target_capability | Required | None |
...
| `prime.chunk.08` | gemini_dcoir_agent, openai_dcoir_analyst | Gemini retains Prime orchestration; OpenAI targets receive flattened, capability-gated adaptations. | Gemini behavior adapter; gemini prime reassembly; provider-specific instruction compilers; shared behavior module manifest | behavior_coverage; byte_identity_adapter; source_contract; target_capability | Required | None |
...
| `knowledge.core.elastic_quick_start` | `knowledge/Knowledge - Core - Elastic Quick Start.md` | runtime_reference | include | `dcoir_elastic_ops` | `excluded` | Preserve ordered source boundary and SHA-256; Validate headings and source-boundary markers during projection; do not silently deduplicate normative text. |
...
| `knowledge.core.overview` | `knowledge/Knowledge - Core - Overview and About.md` | runtime_reference | include | `dcoir_core` | `excluded` | Preserve ordered source boundary and SHA-256; Validate headings and source-boundary markers during projection; do not silently deduplicate normative text. |
