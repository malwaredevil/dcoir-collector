...
- Covered source files:
  ...
  - `project_sources/collector/source/parts/DCOIR_Collector.02D1C_Baseline_Collection_Context.ps1`
...
| --- | --- | ---: | --- |
| `dot_source_variable` | `project_sources/collector/source/DCOIR_Collector.ps1` | 219 | `. $partPath` |
