...
| `harness source parts and generated harness` | source-part paths when #262 analyzer targets .ps1 surfaces; generated output when materialized and explicitly targeted | source-part drift risks through #264 fixtures plus #265 parity proof | ordered source input map, generated harness hash, optional checked-in comparison, parse status, and line map |
